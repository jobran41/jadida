...
<body>
	...
	<ul class="uk-grid  uk-grid-width-medium-1-3 " id="content" style="transition: transform 150ms linear 0s;" data-uk-grid-margin="" >
					...
					<li>
		        		<div class="uk-overlay uk-overlay-hover">
	                        <div class="cadre">
		                        ...
		                        <div class="uk-overlay-panel uk-overlay-plus-circle uk-icon-plus-circle uk-overlay-background uk-overlay-slide-left"></div>
